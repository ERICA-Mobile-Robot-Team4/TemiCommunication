...
public class Mission0 extends AppCompatActivity implements OnRobotReadyListener {
    ...
    // 지도 장소 버튼들
    LinearLayout sceneStudy;    // SCENE 1: 서재
    LinearLayout sceneDining;   // SCENE 2: 식당
    LinearLayout sceneKitchen;  // SCENE 3: 주방
    LinearLayout sceneBasement; // SCENE 4: 지하실 (잠금)
    LinearLayout sceneServant;  // SCENE 5: 하인숙소
    LinearLayout sceneHall;     // SCENE 6: 현관홀
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // ── SCENE 2: 식당 (미구현 - 추후 Mission 클래스 연결)
        sceneDining.setOnClickListener(v -> {
            Toast.makeText(this, "식당 수사 준비 중입니다.", Toast.LENGTH_SHORT).show();
        });
        ...
        sceneBasement.setOnClickListener(v -> {
            Toast.makeText(this, "🔒 지하실은 아직 잠겨 있습니다.", Toast.LENGTH_SHORT).show();
        });
        ...
        sceneHall.setOnClickListener(v -> {
            Toast.makeText(this, "현관홀 수사 준비 중입니다.", Toast.LENGTH_SHORT).show();
        });
    }
