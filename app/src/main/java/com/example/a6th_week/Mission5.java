...
public class Mission5 extends AppCompatActivity implements Robot.TtsListener, Robot.AsrListener, OnRobotReadyListener {
...
//            startActivity(intent);
    ...
    public void onRobotReady(boolean isReady) {
        ...
        try {
            ...
            if (!introPlayed) {
                introPlayed = true;
                robot.speak(com.robotemi.sdk.TtsRequest.create("이곳은 저택에 하인들이 머무는 방입니다. 수색을 진행하세요.", false));
            }
